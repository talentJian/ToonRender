Shader "UI Extend/Default_SoftClip4Edge"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			inline half UnityGet2DClipping_Soft(in float2 position, in float4 clipRect, in half4 softness)
			{
			...
			fixed4 frag(v2f IN) : SV_Target
			{
				...
				color.a *= UnityGet2DClipping_Soft(IN.worldPosition.xy, _ClipRect, _Softness);
